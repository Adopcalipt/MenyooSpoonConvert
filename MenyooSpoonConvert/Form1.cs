...
namespace MenyooSpoonConvert
{
    public partial class Form1 : Form
    {
        ...
        string sMayFile = "";
        string sOutputFile = "";
        public static XYZAdjust PropAdj { get; set; }
        public static XYZAdjust VehAdj { get; set; }
        public static XYZAdjust PedAdj { get; set; }
        ...
        {
            InitializeComponent();
            PropAdj = new XYZAdjust();
            VehAdj = new XYZAdjust();
            PedAdj = new XYZAdjust();
            ReadVehAndPedList();
        ...
        private void SpoonConversion(string fileName, Form3Output FormOutPut)
        {
            if (File.Exists(fileName))
            {
                ...
                for (int i = 0; i < MyColect.Count(); i++)
                {
                    ...
                    else if (line.Contains("<X>") )
                    {
                        ...
                        decimal fNum = (decimal)Convert.ToDouble(line);
                        fNum = Math.Round(fNum, 3);

                        if (bAttach)
                            MyConverstion[iMyConvert].RattachPlace.PosX = fNum;
                        else
                            MyConverstion[iMyConvert].Rplace.PosX = fNum;
                    }
                    else if (line.Contains("<Y>") )
                    {
                        ...
                        if (bAttach)
                            MyConverstion[iMyConvert].RattachPlace.PosY = fNum;
                        else
                            MyConverstion[iMyConvert].Rplace.PosY = fNum;
                    }
                    else if (line.Contains("<Z>") )
                    {
                        ...
                        if (bAttach)
                            MyConverstion[iMyConvert].RattachPlace.PosZ = fNum;
                        else
                            MyConverstion[iMyConvert].Rplace.PosZ = fNum;
                    }
                    else if (line.Contains("<Pitch>") )
                    {
                        ...
                        if (bAttach)
                            MyConverstion[iMyConvert].RattachPlace.RotX = fNum;
                        else
                            MyConverstion[iMyConvert].Rplace.RotX = fNum;
                    }
                    else if (line.Contains("<Roll>") )
                    {
                        ...
                        if (bAttach)
                            MyConverstion[iMyConvert].RattachPlace.RotY = fNum;
                        else
                            MyConverstion[iMyConvert].Rplace.RotY = fNum;
                    }
                    else if (line.Contains("<Yaw>"))
                    {
                        ...
                        if (bAttach)
                            MyConverstion[iMyConvert].RattachPlace.RotZ = fNum;
                        else
                            MyConverstion[iMyConvert].Rplace.RotZ = fNum;
                    }
                }
                SpoonPrint(MyConverstion, FormOutPut);
            }
        }
        private void SpoonPrint(List<SpoonConvert> MyCon, Form3Output FormOutPut)
        {
            ...
            {
                PrintOutSyatem("//-------Props-------");
                PrintOutSyatem(FormOutPut.PropLine01);
                PrintOutSyatem(FormOutPut.PropLine02);
                PrintOutSyatem(FormOutPut.PropLine03);

                for (int i = 0; i < ObjectList.Count(); i++)
                {
                    decimal PosX = ObjectList[i].Rplace.PosX + PropAdj.PosX;
                    decimal PosY = ObjectList[i].Rplace.PosY + PropAdj.PosY;
                    decimal PosZ = ObjectList[i].Rplace.PosZ + PropAdj.PosZ;

                    decimal RotX = ObjectList[i].Rplace.RotX + PropAdj.RotX;
                    decimal RotY = ObjectList[i].Rplace.RotY + PropAdj.RotY;
                    decimal RotZ = ObjectList[i].Rplace.RotZ + PropAdj.RotZ;

                    string sPlace01 = "";
                    if (FormOutPut.PropT01 == 1)
                        sPlace01 = "\"" + ObjectList[i].Sname + "\"";
                    else if (FormOutPut.PropT01 == 2)
                        sPlace01 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.PropT01 == 3)
                        sPlace01 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";
                    string sPlace02 = "";
                    if (FormOutPut.PropT02 == 1)
                        sPlace02 = "\"" + ObjectList[i].Sname + "\"";
                    else if (FormOutPut.PropT02 == 2)
                        sPlace02 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.PropT02 == 3)
                        sPlace02 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";
                    string sPlace03 = "";
                    if (FormOutPut.PropT03 == 1)
                        sPlace03 = "\"" + ObjectList[i].Sname + "\"";
                    else if (FormOutPut.PropT03 == 2)
                        sPlace03 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.PropT03 == 3)
                        sPlace03 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";

                    PrintOutSyatem(FormOutPut.PropText01 + sPlace01 + FormOutPut.PropText02 + sPlace02 + FormOutPut.PropText03 + sPlace03 + FormOutPut.PropText04);
                }
            }
            ...
            if (VehList.Count > 0)
            {
                ...
                PrintOutSyatem(FormOutPut.VehLine01);
                PrintOutSyatem(FormOutPut.VehLine02);
                PrintOutSyatem(FormOutPut.VehLine03);

                for (int i = 0; i < VehList.Count(); i++)
                {
                    decimal PosX = VehList[i].Rplace.PosX + VehAdj.PosX;
                    decimal PosY = VehList[i].Rplace.PosY + VehAdj.PosY;
                    decimal PosZ = VehList[i].Rplace.PosZ + VehAdj.PosZ;

                    decimal RotX = VehList[i].Rplace.RotX + VehAdj.RotX;
                    decimal RotY = VehList[i].Rplace.RotY + VehAdj.RotY;
                    decimal RotZ = VehList[i].Rplace.RotZ + VehAdj.RotZ;

                    string sPlace01 = "";
                    if (FormOutPut.VehT01 == 1)
                        sPlace01 = "\"" + VehList[i].Sname + "\"";
                    else if (FormOutPut.VehT01 == 2)
                        sPlace01 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.VehT01 == 3)
                        sPlace01 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";
                    string sPlace02 = "";
                    if (FormOutPut.VehT02 == 1)
                        sPlace02 = "\"" + VehList[i].Sname + "\"";
                    else if (FormOutPut.VehT02 == 2)
                        sPlace02 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.VehT02 == 3)
                        sPlace02 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";
                    string sPlace03 = "";
                    if (FormOutPut.VehT03 == 1)
                        sPlace03 = "\"" + VehList[i].Sname + "\"";
                    else if (FormOutPut.VehT03 == 2)
                        sPlace03 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.VehT03 == 3)
                        sPlace03 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";

                    PrintOutSyatem(FormOutPut.VehText01 + sPlace01 + FormOutPut.VehText02 + sPlace02 + FormOutPut.VehText03 + sPlace03 + FormOutPut.VehText04);
                }
            }
            ...
            {
                PrintOutSyatem("//-------Peds-------");
                PrintOutSyatem(FormOutPut.PedLine01);
                PrintOutSyatem(FormOutPut.PedLine02);
                PrintOutSyatem(FormOutPut.PropLine03);

                for (int i = 0; i < PedList.Count(); i++)
                {
                    decimal PosX = PedList[i].Rplace.PosX + PedAdj.PosX;
                    decimal PosY = PedList[i].Rplace.PosY + PedAdj.PosY;
                    decimal PosZ = PedList[i].Rplace.PosZ + PedAdj.PosZ;

                    decimal RotX = PedList[i].Rplace.RotX + PedAdj.RotX;
                    decimal RotY = PedList[i].Rplace.RotY + PedAdj.RotY;
                    decimal RotZ = PedList[i].Rplace.RotZ + PedAdj.RotZ;

                    string sPlace01 = "";
                    if (FormOutPut.PedT01 == 1)
                        sPlace01 = "\"" + PedList[i].Sname + "\"";
                    else if (FormOutPut.PedT01 == 2)
                        sPlace01 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.PedT01 == 3)
                        sPlace01 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";
                    string sPlace02 = "";
                    if (FormOutPut.PedT02 == 1)
                        sPlace02 = "\"" + PedList[i].Sname + "\"";
                    else if (FormOutPut.PedT02 == 2)
                        sPlace02 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.PedT02 == 3)
                        sPlace02 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";
                    string sPlace03 = "";
                    if (FormOutPut.PedT03 == 1)
                        sPlace03 = "\"" + PedList[i].Sname + "\"";
                    else if (FormOutPut.PedT03 == 2)
                        sPlace03 = "new Vector3(" + PosX + "f, " + PosY + "f, " + PosZ + "f)";
                    else if (FormOutPut.PedT03 == 3)
                        sPlace03 = "new Vector3(" + RotX + "f, " + RotY + "f, " + RotZ + "f)";

                    PrintOutSyatem(FormOutPut.PedText01 + sPlace01 + FormOutPut.PedText02 + sPlace02 + FormOutPut.PedText03 + sPlace03 + FormOutPut.PedText04);
                }
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (sMayFile != "" || sMayFile != "Nothing Selected")
            {
                ...
                if (testDialog.sNamed != "")
                {
                    ...
                    Form3 HowYouLike = new Form3();
                    HowYouLike.ShowDialog(this);

                    while (HowYouLike.MyOutPut == null)
                    { }

                    Form3Output ThisForm = HowYouLike.MyOutPut;
                    HowYouLike.Dispose();

                    SpoonConversion(sMayFile, ThisForm);
                }
            }
        }
    }
